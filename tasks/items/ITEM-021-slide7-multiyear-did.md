...
**ゼミからの指摘(要検討)**: スライド6(交易損失/曝露)とスライド7(五分位別支出割合)のデータで **差の差分法(DiD)** が使えるのではないか、という指摘を受けた。証明の仕方をこの方向で組めないか検討する。(2026-07-24 訂正: 指摘者は聴講者ではなく**先生(指導教員)**。第3回デッキに回答枠 s8b を新設して対応)
