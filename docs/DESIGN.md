...
### Hierarchy (4 levels, clearly differentiated)

| Level | Role | Approximate size guidance |
|-------|------|--------------------------|
| L1: Slide title | Topic + argument in short form | Large — readable at 70% scale from distance |
| L2: Anchor claim | Primary message of anchor slides; key takeaway sentence | Larger than body — this is the focal point |
| L3: Card heading / label | Section header within a slide, category name | Medium-large — clearly above body |
| L4: Body text | Bullets, explanatory content | Medium — minimum readable at 70% scale |
| L5: Note / source | Citations, footnotes, caveats | Smaller but legible — never microtext |
